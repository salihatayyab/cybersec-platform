...
└─────────────────────────────────────────────────────────────┘
                        ...
                        Security Logs
                              ...
                              ▼
                      ┌───────────────┐
                      │  Apache Kafka │  (Real-time log ingestion)
                      └───────────────┘
                              │
                              ▼
                      ┌───────────────┐
                      │  Apache Spark │  (Clean, normalize, process)
                      └───────────────┘
                              │
                              ▼  
                      ┌───────────────┐
                      │Data Lake + Data Warehouse  │  (Raw + processed storage)
                      └───────────────┘
                              │
        ┌──────────┬─────────┼─────────┬──────────┐
        ▼          ▼          ▼          ▼          ▼
 ┌────────────┐┌──────────┐┌──────────┐┌────────┐
 │ Isolation  ││ XGBoost  ││ Random   ││ LSTM   ││ Prophet    │
 │ Forest     ││          ││ Forest   ││        ││            │
 │ (UEBA)     ││(Ensemble)││(Ensemble)││(Sequen-││(Predict-   │
 │            ││          ││          ││ tial)  ││ ive)       │
 └────────────┘└──────────┘└──────────┘└────────┘
        │          │          │          │          │
        └──────────┴─────────┬┴──────────┴──────────┘
...
**Docker & DevOps** — Managing services with Docker Compose, networking them together, and debugging cross-container communication issues.
